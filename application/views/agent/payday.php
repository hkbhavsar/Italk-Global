                ...
                <form method="post"  id="form-validation-lead" autocomplete="off">
                    ...
                    <div class="g_3_4_last">
                        ...
                        <div class="g_1_4" style="width:14.5%">
                            &nbsp;&nbsp;&nbsp;<label for="af-present">Check Deposit: </label>
                        </div>
                        <div class="g_1_4">
                           <select data-validation-type="present" name="check_deposite">
                                <option value="">-select option-</option>
                    ...
                    <div class="spacer-20">
                     ...
                     <div class="g_1_4">
                        <label for="af-present">Employer Name: </label>
                    </div>
                    <div class="g_3_4_last">
                        <div class="g_1_4">
                             <input type="text" name="employer_name" value=""  id="employer_name" data-validation-type="present" /> 
                       </div>
                        <div class="g_1_4" style="width:13.5%">
                            &nbsp;&nbsp;&nbsp;<label for="af-present">Job Title: </label>
                        </div>
                        <div class="g_1_4">
                           <input type="text" name="job_title" value=""  id="job_title" data-validation-type="present" /> 
                        </div>
                    </div>
                    <div class="spacer-20">
                        <!-- spacer 20px -->
                    ...
                    <div class="g_3_4_last">
                        <div class="g_1_4">
                             <input type="text" name="employer_phone" value=""  id="employer_phone" data-validation-type="present" /> 
                       </div>
                        <div class="g_1_4" style="width:17.5%">
                            &nbsp;&nbsp;&nbsp;<label for="af-present">Employer Address: </label>
                        </div>
                        <div class="g_1_4">
                           <input type="text" name="employer_address" value=""  id="employer_address" data-validation-type="present" /> 
                        </div>
                    </div>
                    <div class="spacer-20">
                        <!-- spacer 20px -->
                    ...
                    <div class="g_1_4">
                        <label for="af-present">Employer City: </label>
                    </div>
                    <div class="g_3_4_last">
                        <div class="g_1_4">
                             <input type="text" name="employer_city" value=""  id="employer_city" data-validation-type="present" /> 
                       </div>
                        <div class="g_1_4" style="width:14.5%">
                            &nbsp;&nbsp;&nbsp;<label for="af-present">Employer State: </label>
                        </div>
                        <div class="g_1_4">
                           <input type="text" name="employer_state" value=""  id="employer_state" data-validation-type="present" /> 
                        </div>
                    </div>
                    <div class="spacer-20">
                        <!-- spacer 20px -->
                     ...
                     <div class="g_1_4">
                        <label for="af-present">Employer Zip: </label>
                    </div>
                    <div class="g_3_4_last">
                        <div class="g_1_4">
                             <input type="text" name="employer_zip" value=""  id="employer_zip" data-validation-type="present" /> 
                       </div>
                        <div class="g_1_4" style="width:14.5%">
                            &nbsp;&nbsp;&nbsp;<label for="af-present">Shift Hours: </label>
                        </div>
                        <div class="g_1_4">
                           <input type="text" name="shift_hrs" value=""  id="shift_hrs" data-validation-type="present" /> 
                        </div>
                    </div>
                    <div class="spacer-20">
                        <!-- spacer 20px -->
                    ...
                    <div class="g_3_4_last">
                        ...
                        <div class="g_1_4" style="width:23.5%">
