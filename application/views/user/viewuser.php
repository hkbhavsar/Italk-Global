          ...
          <tbody>
            ...
            <?php if(count($user_data)>0){  foreach($user_data as $key=>$value){$i=1; $l = 2;?>
             <tr>
              ...
              <td width="5%">&nbsp;&nbsp;&nbsp;<?php if($value->id!=2){?><img src="<?php echo Kohana::$base_url; ?>images/delete.png" alt="delete" onclick="submitfrmdelete(<?php echo $value->id;?>);"><?php }?></td>
              ...
              <td><?php echo $value->role_id==1?'Admin':'Agent';?></td>
