...
<div class="dialog error">
    <p><img alt="" src="<?php echo Kohana::$base_url; ?>images/icons/dialogs/warning-16.png">Trim Deleted Successfully</p>
    <span>x</span>
</div>
<?php }?>
    <div>
        ...
        <table class="basic-table" id="tableexample1">
          <thead>
            <tr>
              ...
              <th scope="col" style="text-align: center;">&nbsp;Trim Name</th>
          ...
          <tbody>
            <!-- new row -->
            <?php if(count($trimData)>0){  foreach($trimData as $key=>$value){?>
             <tr>
              <td width="1%"><input type="checkbox" name="ch[]" value="<?php echo $value->trim_id;?>" <?php echo $checked;?>/></td>
              <td width="5%">&nbsp;&nbsp;&nbsp;<img src="<?php echo Kohana::$base_url; ?>images/delete.png" alt="delete" onclick="submitfrmdelete(<?php echo $value->trim_id;?>);"></td>
              <td width="5%">&nbsp;&nbsp;&nbsp;<a href="<?php echo Kohana::$base_url; ?>trim/add/<?php echo $value->model_id;?>"><img src="<?php echo Kohana::$base_url; ?>images/edit.gif" alt="edit"></a></td>
              <td><?php echo $value->trim_name;?></td>
              <td><?php echo $value->make_name;?></td>
              <td><?php echo $value->model_name;?></td>
             </tr>
            <?php $i++;}?>
            <tr><td colspan="6"><?php echo $page_links_pagging_trim;?></td></tr>
            <?php }else{?>
             <tr>
