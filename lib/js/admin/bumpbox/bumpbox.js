...
$(document.body).ready(function() {
	...
	$('.bumpbox').click(function(e){
		...
		var el = $('<div style="width:1px;height:1px;position:absolute;border:2px solid #303132;padding:4px;background:#000 url(' + path + 'ajax-loader.gif) no-repeat center center;left:' + middleH + 'px;top:' + (middleV+s) + 'px;cursor:pointer;display:block;z-index:100000;-moz-border-radius:10px;-webkit-border-radius:10px;border-radius:10px;"></div>');

		var bg = $('<div style="background:#000;width:100%;height:100%;opacity:0.9;position:absolute;z-index:4;top:' + s + 'px;left:0;"></div>');
